...
class AreaTasksTracker(tk.Frame):
    def __init__(self, parent, controller):
        ...
        canvas.create_text(320, 50, text="Area Tasks Tracker", font=("Arial", 24, "bold"), fill="white")
    ...
    def create_grid(self):
        ...
        data = [
            ...
            [("ARCHAEOLOGY", os.getenv("ARCHAEOLOGY_LEVEL") + f" / {arc}"), ("NECROMANCY", os.getenv("NECROMANCY_LEVEL") + f" / {nec}"), ("OVERALL", os.getenv("OVERALL_LEVEL") + f" / {ove}")]
        ]
        ...
        for row in range(len(data)):
            for col in range(len(data[row])):
                ...
                self.grid_canvas.create_text(text_x, text_y, text=f"       {skill_level}", font=("Arial", 10), fill="white", tags="grid")
